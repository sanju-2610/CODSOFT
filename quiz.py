...
questions = ["Question 1/5 , What is 1 + 1 = ?","Question 2/5 , What is 2 + 2 = ?","Question 3/5 , What is 3 + 3 = ?","Question 4/5 , What is 4 + 4 = ?","Question 5/5 , What is 5 + 5 = ?"]
options = [['5','6','2','8','2'],['8','4','6','7','4'],
           ['9','5','3','6','6'],['8','5','3','9','8'],['1','10','5','7','10']]
...
def displayNextQuestion():
    ...
    if index == len(options):
       question_label['text'] ="Your Score: " + str(correct) + " / " + str(len(options))
